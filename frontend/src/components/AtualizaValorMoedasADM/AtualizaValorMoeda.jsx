...
function ValorMoedas(){
  ...
  const [playXbox, setPlayXbox] = useState("");
  const [pc, setPc] = useState("");
  const [precos, setPrecos] = useState({ play: 0, xbox: 0, pc: 0 }); // inicializado
  ...
  const formatar = (valor) =>
    ...
    return(
      <div className="containerValorMoedas">
        <div className="boxAtualizarMoedas">
            ...
            <input className="inputadnim" type="number" placeholder="Valor de 1000K para Playstation e Xbox" value={playXbox} onChange={(e) => setPlayXbox(e.target.value)} />
            <input className="inputadnim" type="number" placeholder="Valor de 1000K para Pc" value={pc} onChange={(e) => setPc(e.target.value)} />
            <button className="buttonadmin" onClick={atualizarPrecos}>
              Atualizar
            </button>

            <div className="plataformas">
              <div className="coinplaystation">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-playstation svgPlataforma" viewBox="0 0 16 16" >
                ...
                <h3 className="h3preco">{formatar(precos.play)}</h3>
              </div>

              <div className="coinsXbox">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-xbox svgPlataforma" viewBox="0 0 16 16" >
                ...
                <h3 className="h3preco">{formatar(precos.xbox)}</h3>
              </div>

              <div className="coinsPc">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-laptop svgPlataforma" viewBox="0 0 16 16" >
                  <path d="M13.5 3a.5.5 0 0 1 .5.5V11H2V3.5a.5.5 0 0 1 .5-.5zm-11-1A1.5 1.5 0 0 0 1 3.5V12h14V3.5A1.5 1.5 0 0 0 13.5 2zM0 12.5h16a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 12.5"/>
                </svg>
                <h3 className="h3preco">{formatar(precos.pc)}</h3>
              </div>
            </div>
        </div>
      </div>
