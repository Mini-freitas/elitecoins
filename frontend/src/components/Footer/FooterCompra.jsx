...
const FooterCompra = ({usuario, handleLogout }) => {
  // função para voltar ao topo
  const scrollToTop = () => {
    const el = document.getElementById("titulo_menu");
    if (el) {
      el.scrollIntoView({ behavior: "smooth", block: "center" });
    }
  };

  // função de scroll para qualquer seção
      ...
      <AlinhaFooter>
        <ContainerRedesSociais>
          ...
          <BoxIconesFooter>
            ...
            <CirculoIconeFooter href="https://www.instagram.com/elitecoinsfc26?igsh=ZmhxdTQzd2szM2Ez">
              <CirculoIconeFooterSvg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            ...
            <CirculoIconeFooter href="">
              <CirculoIconeFooterImg src={iconeYoutoobe} alt="Icone Youtoobe" />
            </CirculoIconeFooter>
          </BoxIconesFooter>
        </ContainerRedesSociais>
        ...
        <ContainerFooter>
          <List>
            ...
            <ListItem onClick={() => scrollToSection("titulo_duvidas")}>Tutorial</ListItem>
        ...
        <ContainerAgradecimentos>
          <BtsFooter>
            ...
            <VoltarTopo onClick={scrollToTop}>Voltar ao topo</VoltarTopo>
          </BtsFooter>
          <h4>
