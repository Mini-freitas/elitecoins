// src/components/CadBanner/CadBanner.jsx
...
function CadBanner({ onBannerSalvo }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      await api.post("/upload-banner", formData, {
    ...
    <div className="containerCadastroBanner">
      <div className="boxAtualizarMoedas">
        ...
        <span
          ...
          style={{ backgroundColor: preview ? "transparent" : "#1b1b1b" }}
        >
          {preview ? (
            <img
              className="imgadmin"
            ...
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-cloud-arrow-up uploadsvg"
              viewBox="0 0 16 16"
            >
        ...
        <input
          type="text"
          placeholder="Coloque a url do banner aqui"
